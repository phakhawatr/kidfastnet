        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <button
              ...
              className="px-3 py-2 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-medium transition-all duration-300 hover:scale-105 text-sm flex items-center gap-2 shadow-md hover:shadow-lg group"
              title={t('refresh')}
            >
